          ...
          <main className="w-full flex flex-col py-4 flex-grow max-w-5xl items-center">
            <div className="w-3/4 border-2 border-blue-600 rounded-xl p-3 mt-10">
              <div className="flex flex-col justify-center">
                ...
                <p className="mt-4">You have to stake 0.05 MATIC to create an investment proposal.</p>
                <p className="text-sm mb-4">
                  If the proposal is accepted, you will be refunded. If the proposal is rejected then your staked coins
                  will go to Club&apos;s treasury.
                </p>
                <form onSubmit={handleSubmit}>
                  ...
                  <button className="mt-3 px-3 py-2 rounded-xl bg-blue-600 text-white" type="submit">
                    Create Proposal
                  </button>
                </form>
              </div>
